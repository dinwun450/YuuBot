# YuuBot Web - Setup & Running Instructions
...
YuuBot Web is a real-time earthquake data visualization web application that displays earthquake information from Japan and globally. This version uses **Snowflake** for data storage and provides an interactive dashboard with earthquake monitoring capabilities.

## Prerequisites

Before running YuuBot Web, ensure you have the following:
