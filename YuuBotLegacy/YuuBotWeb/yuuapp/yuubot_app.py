...
from Github.YuuBot.YuuBotLegacy.YuuBotWeb.yuuapp.data.jp_earthquakes_extractor import get_earthquake_data
from Github.YuuBot.YuuBotLegacy.YuuBotWeb.yuuapp.data.date_of_earthquakes import extract_date
