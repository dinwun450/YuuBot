...
from Github.YuuBot.YuuBotLegacy.YuuBotChat.yuuapp_chat.data.jp_earthquakes_extractor_chat import get_earthquake_data
from Github.YuuBot.YuuBotLegacy.YuuBotChat.yuuapp_chat.data.date_of_earthquakes import extract_date
